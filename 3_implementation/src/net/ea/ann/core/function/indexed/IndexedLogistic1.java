...
/**
 * Indexed logistic function with scalar variable.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class IndexedLogistic1 extends Logistic1 {
	 ...
	 */
	public IndexedLogistic1(double min, double max, double slope) {
		super(min, max, slope);
	}
	 ...
	 * @param max maximum value.
	 */
	public IndexedLogistic1(double min, double max) {
		super(min, max);
	}
