...
/**
 * This class represents indexed logistic function with vector variable.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class IndexedLogisticV extends LogisticV {
	 ...
	 */
	public IndexedLogisticV(double[] min, double[] max, double[] slope) {
		super(min, max, slope);
	}
	 ...
	 * @param max maximum array.
	 */
	public IndexedLogisticV(double[] min, double[] max) {
		super(min, max);
	}
	 ...
	 * @param slope slope parameter.
	 */
	public IndexedLogisticV(int dim, double min, double max, double slope) {
	 ...
	 * @param max maximum value.
	 */
	public IndexedLogisticV(int dim, double min, double max) {
		super(dim, min, max);
	}
	 ...
	 * @param dim specific dimension.
	 */
	public IndexedLogisticV(int dim) {
		super(dim);
	}
