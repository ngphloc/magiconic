 ...
 */
@Deprecated
class GenUIDeprecated extends JFrame implements Inspector, SetupAlgListener {
	 ...
	 */
	public GenUIDeprecated(GenModelRemote gm, boolean exclusive) {
		this();
		this.gm = gm;
	 ...
	 * @param gm generative model.
	 */
	public GenUIDeprecated(GenModelRemote gm) {
		this(gm, false);
	}
	 ...
	 */
	private GenUIDeprecated getGenUI() {
		return this;
	}
...
//		resultDirButtons.add(btnResultDirLoad);
	 ...
	 *
	 */
	protected class RasterClassfier extends ClassifierUIDeprecated {
	 ...
	 */
	protected GenUIDeprecated queryLocalGenModel(GenModelRemote initialGM, GenUIDeprecated initialUI) {
	 ...
	 * @return local generative model.
	 */
	protected static <T extends GenModelRemote> GenUIDeprecated queryLocalGenModel(Class<T> gmClass, GenModelRemote initialGM, GenUIDeprecated initialUI, GenUICreator<T> genUICreator) {
		...
		if (genUICreator == null) {
			genUICreator = new GenUICreator<T>() {
				...
				@Override
				public GenUIDeprecated create(T gm) {return new GenUIDeprecated(gm, false);}
	...
	public static void main(String[] args) {
		GenUIDeprecated genUI = queryLocalGenModel(GenModelRemote.class, new VAE(), null, null);
