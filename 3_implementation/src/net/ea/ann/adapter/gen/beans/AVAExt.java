...
/**
 * This class is the bean implementation of extended Adersarial Variational Autoencoders for Hudup framework.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class AVAExt extends GenModelAbstract {
	...
	protected ConvGenModel createGenModel() {
		try {
			ConvGenModel model = net.ea.ann.gen.vae.AVAExt.create(getNeuronChannel(), getRasterChannel());
