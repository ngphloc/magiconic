...
public class NormLayerBatch extends MatrixLayerImpl {
	 ...
	 */
	public NormLayerBatch(int neuronChannel, Function activateRef, Function convActivateRef, Id idRef) {
	 ...
	 * @param convActivateRef convolutional activation function.
	 */
	public NormLayerBatch(int neuronChannel, Function activateRef, Function convActivateRef) {
	 ...
	 * @param activateRef activation function.
	 */
	public NormLayerBatch(int neuronChannel, Function activateRef) {
	 ...
	 * @param neuronChannel neuron channel.
	 */
	public NormLayerBatch(int neuronChannel) {this(neuronChannel, null, null, null);}
