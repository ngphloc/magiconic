...
/**
 * This class implements matrix neural network with dropout technique with parameter.
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class PDropoutNetwork extends ParameterNetwork {
	 ...
	 */
	public PDropoutNetwork(int neuronChannel, Function activateRef, Function convActivateRef, Id idRef) {
	 ...
	 * @param convActivateRef convolutional activation function.
	 */
	public PDropoutNetwork(int neuronChannel, Function activateRef, Function convActivateRef) {
	 ...
	 * @param activateRef activation function.
	 */
	public PDropoutNetwork(int neuronChannel, Function activateRef) {
	 ...
	 * @param neuronChannel neuron channel.
	 */
	public PDropoutNetwork(int neuronChannel) {this(neuronChannel, null, null, null);}
	 ...
	 * @return this network.
	 */
	protected PDropoutNetwork paramSetDropoutMode(boolean dropout) {
	 ...
	 * @return network.
	 */
	PDropoutNetwork paramSetDropoutRate(double dropoutRate) {
	...
	@SuppressWarnings("unused")
	@Deprecated
	private PDropoutNetwork paramSetDropoutAll(boolean dropoutAll) {
	 ...
	 * @return this network.
	 */
	PDropoutNetwork paramSetDropoutInverted(boolean inverted) {
