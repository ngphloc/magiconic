 ...
 *
 */
public class PResidualNetwork extends PDropoutNetwork {
	 ...
	 */
	public PResidualNetwork(int neuronChannel, Function activateRef, Function convActivateRef, Id idRef) {
	 ...
	 * @param convActivateRef convolutional activation function.
	 */
	public PResidualNetwork(int neuronChannel, Function activateRef, Function convActivateRef) {
	 ...
	 * @param activateRef activation function.
	 */
	public PResidualNetwork(int neuronChannel, Function activateRef) {
	 ...
	 * @param neuronChannel neuron channel.
	 */
	public PResidualNetwork(int neuronChannel) {this(neuronChannel, null, null, null);}
...
//	 */
//	private PResidualNetwork residualLayerOf(MatrixLayerAbstract startLayer) {
...
//	}
	 ...
	 * @return this network.
	 */
	protected PResidualNetwork paramSetResidualMode(boolean residual) {
	 ...
	 * @return this VGG.
	 */
	protected PResidualNetwork paramSetResidualBatch(boolean residualBatch) {
