...
/**
 * This class implements VGG classifier.
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class SwarmClassifier extends Swarm {
...
//		Util.randomWrite("working/weight_output.txt", NeuronValue.toText(means) + "\n");
	 ...
	 */
	SwarmClassifier paramSetBaseline(boolean baseline) {
	 ...
	 * @return this classifier.
	 */
	SwarmClassifier paramSetBaselineMean(boolean baselineMean) {
	 ...
	 * @return this classifier.
	 */
	public SwarmClassifier paramSetEntropyTrainer(boolean entropyTrainer) {
