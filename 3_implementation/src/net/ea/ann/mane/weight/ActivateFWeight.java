...
/**
 * This class represents filter activation weight which is like null weight but having filter activation function.
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class ActivateFWeight implements Weight {
