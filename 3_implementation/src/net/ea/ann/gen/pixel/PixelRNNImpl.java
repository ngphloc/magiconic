...
public class PixelRNNImpl extends PixelRNNAbstract {
	 ...
	 */
	public PixelRNNImpl(int neuronChannel, int rasterChannel, Size size, Id idRef) {
	 ...
	 * @param idRef identifier reference.
	 */
	public PixelRNNImpl(int neuronChannel, Size size, Id idRef) {
	 ...
	 * @param size layer size.
	 */
	public PixelRNNImpl(int neuronChannel, Size size) {
	 ...
	 * @param neuronChannel neuron channel.
	 */
	public PixelRNNImpl(int neuronChannel) {
