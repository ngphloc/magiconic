 ...
 *
 */
public interface DeconvConvFilter3D extends DeconvFilter3D, DeconvConvFilter2D {
	 ...
	 */
	NeuronValue apply(int x, int y, int z, ConvLayerSingle3D layer, int nextX, int nextY, int nextZ, ConvLayerSingle3D nextLayer);
